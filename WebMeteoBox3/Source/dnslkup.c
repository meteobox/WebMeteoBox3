...
//static uint8_t dnsip[4]={192,168,1,1}; // the google public DNS, don't change unless there is a real need
...
uint8_t dnslkup_request(uint8_t *buf,const char *hostname,const uint8_t *gwmac)
{
        ...
        send_udp_prepare(buf,(DNSCLIENT_SRC_PORT_H<<8)|(dnstid_l&0xff),NetworkParam.dns,53,gwmac);
        // fill tid:
